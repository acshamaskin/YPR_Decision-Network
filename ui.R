...
#titlePanel("Enter Simulation Parameters Below"),
  sidebarLayout(position = "left",
    sidebarPanel(h3(strong("Simulation Parameters"),style = "font-family: 'times'; font-si6pt"),width=5,
      ...
      h4(strong("Parameter Estimates"),style = "font-family: 'times'; font-si6pt"),
                           ...
                           fluidRow(
                             column(4,
                                    ...
                                    checkboxGroupInput("Testattribchoices","Choices:",
                                                       c("Yield"=1,"Average Weight"=2,"Harvest Rate"=3,"Big Fish Harvest"=4,"Harvest Opp."=5,"Quality Harvest Opp."=6)),
                                    br(),
